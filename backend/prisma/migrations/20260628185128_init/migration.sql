-- CreateEnum
CREATE TYPE "RoomType" AS ENUM ('HOT_DESK', 'PRIVATE_CABIN', 'MEETING_ROOM', 'CONFERENCE_ROOM', 'EVENT_SPACE');

-- CreateEnum
CREATE TYPE "DeskType" AS ENUM ('STANDARD', 'STANDING', 'PREMIUM', 'ACCESSIBLE');

-- CreateEnum
CREATE TYPE "BookingStatus" AS ENUM ('PENDING', 'CONFIRMED', 'CANCELLED', 'COMPLETED', 'NO_SHOW');

-- CreateEnum
CREATE TYPE "SubscriptionPlan" AS ENUM ('FREE', 'BASIC', 'BUSINESS', 'ENTERPRISE');
...
-- CreateEnum
CREATE TYPE "NotificationType" AS ENUM ('BOOKING_CREATED', 'BOOKING_CONFIRMED', 'BOOKING_CANCELLED', 'BOOKING_REMINDER', 'SUBSCRIPTION_EXPIRING', 'INVOICE_GENERATED', 'SYSTEM_ALERT');
...
CREATE TABLE "rooms" (
    ...
    "name" TEXT NOT NULL,
    "type" "RoomType" NOT NULL DEFAULT 'HOT_DESK',
...
CREATE TABLE "desks" (
    ...
    "type" "DeskType" NOT NULL DEFAULT 'STANDARD',
    "isActive" BOOLEAN NOT NULL DEFAULT true,
    "createdAt" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "updatedAt" TIMESTAMP(3) NOT NULL,
...
CREATE TABLE "subscriptions" (
    ...
    "maxBookings" INTEGER NOT NULL DEFAULT 50,
...
-- AddForeignKey
ALTER TABLE "desks" ADD CONSTRAINT "desks_roomId_fkey" FOREIGN KEY ("roomId") REFERENCES "rooms"("id") ON DELETE CASCADE ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "bookings" ADD CONSTRAINT "bookings_deskId_fkey" FOREIGN KEY ("deskId") REFERENCES "desks"("id") ON DELETE SET NULL ON UPDATE CASCADE;
